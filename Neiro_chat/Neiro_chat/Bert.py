...
def train_and_save_model(patience=3):
    ...
    df = pd.read_excel("C:/Users/early/Desktop/hack/samo-app/Neiro_chat/Neiro_chat/dataset.xlsx")
    ...
    with open('C:/Users/early/Desktop/hack/samo-app/Neiro_chat/Neiro_chat/category_map.json', 'w') as f:
        json.dump(category_map, f)
    with open('C:/Users/early/Desktop/hack/samo-app/Neiro_chat/Neiro_chat/answer_map.json', 'w') as f:
        json.dump(answer_map, f)
    with open('C:/Users/early/Desktop/hack/samo-app/Neiro_chat/Neiro_chat/exact_answer_map.json', 'w') as f:
    ...
    model.save_pretrained('Neiro_chat/Neiro_chat/fine_tuned_roberta')
    tokenizer.save_pretrained('Neiro_chat/Neiro_chat/fine_tuned_roberta')
    print("Модель успешно обучена и сохранена.")

def load_trained_model():
    model = RobertaForSequenceClassification.from_pretrained('Neiro_chat/Neiro_chat/fine_tuned_roberta').to(device)
    tokenizer = RobertaTokenizer.from_pretrained('Neiro_chat/Neiro_chat/fine_tuned_roberta')
...
def classify_query(model, query):
    ...
    with open('C:/Users/early/Desktop/hack/samo-app/Neiro_chat/Neiro_chat/category_map.json', 'r') as f:
...
def get_answer(query, predicted_label):
    with open('C:/Users/early/Desktop/hack/samo-app/Neiro_chat/Neiro_chat/exact_answer_map.json', 'r') as f:
